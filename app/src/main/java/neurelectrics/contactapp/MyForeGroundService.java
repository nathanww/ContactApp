...
public class MyForeGroundService extends Service {
    ...
    long CONTACT_LIST_TIME = 1000 * 60 * 120; //number of ms contacts on the list should be kept for
    int CONTACT_LIST_MAX = 5; //start disregarding signals if they appear in more than this many scans
